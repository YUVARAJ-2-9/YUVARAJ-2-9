...
- 🧠 Currently sharpening my **Data Structures & Algorithms (DSA)** for placement interviews
- 💻 Building full-stack projects with **React, Java, and MongoDB**
...
<table>
  <tr>
    <td width="50%">
      <h4>💊 MedRemainder</h4>
      <p>A medicine reminder application built to help users stay on top of their medication schedule.</p>
      <a href="https://github.com/YUVARAJ-2-9/-medicine-reminder">🔗 View Repository</a>
    </td>
    <td width="50%">
